...
const Loader = () => {
    return (
        <div className='flex justify-center align-middle items-center' aria-label="Loading..." role="status">
            <svg className="animate-spin w-8 h-8 stroke-blue-500" viewBox="0 0 256 256">

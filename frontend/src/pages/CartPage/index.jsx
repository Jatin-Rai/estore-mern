    ...
    <div className="h-screen">
      ...
      <div className={`flex gap-10`}>
        {cartItems.length === 0 ? (
          <div className='w-3/4'>
            <Message
              icon={<FaBell />} variant="bg-blue-400"
            >
              Your cart is empty
            </Message>
          </div>
        ) : (
          <table className="table-auto w-3/4 shadow">
              ...
              {cartItems.map((item) => (
                <>
                  <tr key={item._id} className='shadow'>
                    ...
                    <td className='px-1 py-2'>
                      <FaTrash className='text-red-500 hover:text-red-600 text-xl'
        ...
        <div className='shadow w-1/4 h-1/2 pb-5 px-5 text-center'>
          ...
          <button
            type='button'
            className={`${cartItems.length === 0 ? "bg-gray-400" : "bg-gray-900"} text-white p-2 hover:rounded-full`}
